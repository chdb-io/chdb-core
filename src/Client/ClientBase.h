...
public:
    ...
    /// chdb_spec: upstream keeps everything below here private. ChdbClient drives ClientBase
    /// directly - it is the embedded client, not a subclass that only overrides hooks - so the
    /// section stays public. Do not reinstate upstream's `private:` label.
