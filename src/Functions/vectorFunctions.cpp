...
└───────────────────────────────────────┘
    ...
    CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionDotProductTransposed>(documentation_dot_product_transposed));
...
└──────────────────────────────────────────────────────────────────────────────┘
    ...
    CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionL2DistanceTransposedQuantized>(documentation_l2_distance_transposed_quantized));
...
└────────────────────────────────────────────────────────────────────────────────────────────┘
    ...
    CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionCosineDistanceTransposedQuantized>(documentation_cosine_distance_transposed_quantized));
...
└──────────────────────────────────────────────────────────────────────────────┘
    ...
    CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionDotProductTransposedQuantized>(documentation_dot_product_transposed_quantized));
    ...
    CHDB_LITE_VEC(factory.registerAlias("scalarProductTransposed", DotProductTransposedName, FunctionFactory::Case::Insensitive));
...
└─────────────────────────────────────────┘
    ...
    CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionL1Normalize>(documentation_l1_normalize));
    CHDB_LITE_VEC(factory.registerAlias("normalizeL1", TupleOrArrayFunctionL1Normalize::name, FunctionFactory::Case::Insensitive));
...
└─────────────────────┘
    ...
    CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionL2Normalize>(documentation_l2_normalize));
    CHDB_LITE_VEC(factory.registerAlias("normalizeL2", TupleOrArrayFunctionL2Normalize::name, FunctionFactory::Case::Insensitive));
...
└───────────────────────┘
    ...
    CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionLinfNormalize>(documentation_linf_normalize));
    CHDB_LITE_VEC(factory.registerAlias("normalizeLinf", TupleOrArrayFunctionLinfNormalize::name, FunctionFactory::Case::Insensitive));
...
└─────────────────────────────────────────┘
        ...
        CHDB_LITE_VEC(factory.registerFunction<TupleOrArrayFunctionLpNormalize>(documentation_lp_normalize));
    }
    CHDB_LITE_VEC(factory.registerAlias("normalizeLp", TupleOrArrayFunctionLpNormalize::name, FunctionFactory::Case::Insensitive));
}
}
