...
static const struct statement_case k_all_statements[] = {
    ...
    {"ParserCreateHandlerQuery", "CREATE HANDLER h URL '/h'", CHDB_QUERY_MUTATING_GLOBAL},
    {"ParserCreateHandlerQuery", "ALTER HANDLER h METHODS (GET)", CHDB_QUERY_MUTATING_GLOBAL},
    {"ParserDropHandlerQuery", "DROP HANDLER h", CHDB_QUERY_MUTATING_GLOBAL},
    {"ParserHypotheticalObjectQuery", "CREATE HYPOTHETICAL INDEX hi ON t (a) TYPE minmax", CHDB_QUERY_CONTROL},
    {"ParserHypotheticalObjectQuery", "CREATE HYPOTHETICAL PROJECTION hp ON t (SELECT a ORDER BY a)", CHDB_QUERY_CONTROL},
    {"ParserHypotheticalObjectQuery", "DROP ALL HYPOTHETICAL INDEXES", CHDB_QUERY_CONTROL},
    {"ParserHypotheticalObjectQuery", "DROP ALL HYPOTHETICAL PROJECTIONS", CHDB_QUERY_CONTROL},
    /* Access management */
    {"ParserCreateUserQuery", "CREATE USER u IDENTIFIED WITH no_password", CHDB_QUERY_MUTATING_GLOBAL},
    {"ParserCreateTokenQuery", "CREATE TOKEN VALID FOR INTERVAL 30 DAY", CHDB_QUERY_MUTATING_GLOBAL},
