...
#    error "The only supported platforms are x86_64 and AArch64, PowerPC (work in progress), s390x (work in progress), loongarch64 (experimental), RISC-V 64 (experimental), E2K (experimental, work in progress) and WASM (experimental, work in progress)"
#endif
